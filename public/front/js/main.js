...
(function ($) {
 ...
 /*----------------------------
  ...
  $(window).scroll(function () {
    var window_top = $(window).scrollTop() + 1;
    if (window_top > 5) {
      $('.search_bar').addClass('menu_fix animated fadeInDown');
    } else {
      $('.search_bar').removeClass('menu_fix animated fadeInDown');
    }
  });
...
//   var navoff = $(".search_bar").offset().top;

//     $(window).scroll(function () {
//         var scrolling = $(this).scrollTop();

//         if (scrolling > navoff) {
//             $(".search_bar").addClass("menu_fix");
//         } else {
//             $(".search_bar").removeClass("menu_fix");
//         }
//     });
