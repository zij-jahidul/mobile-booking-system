        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Brand URL</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="row">
            <div class="col-12">
                ...
                <section class="content">
                    <div class="container-fluid">
                      <!-- SELECT2 EXAMPLE -->
                    <form action="{{ url('admin/url-edit-brand-post') }}" method="POST">
                        <input type="hidden" name="brand_id" value="{{ $brand_info->id }}">
                        @csrf
                        {{-- @method('PATCH') --}}
                      <div class="card card-default card-primary">
                        <div class="card-header">
                          <h3 class="card-title">Edit {{ $brand_info->brand_name }} URL</h3>
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="brand_url" name="brand_url" placeholder="Enter URL" value="{{ $brand_info->brand_url }}">
                                  </div>
                            </div>
