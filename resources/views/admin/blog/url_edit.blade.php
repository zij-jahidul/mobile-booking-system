        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Blog URL</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="row">
            <div class="col-12">
                ...
                <section class="content">
                    <div class="container-fluid">
                      <!-- SELECT2 EXAMPLE -->
                    <form action="{{ url('admin/url-edit-blog-post') }}" method="POST">
                        <input type="hidden" name="blog_id" value="{{ $blog_info->id }}">
                        @csrf
                        {{-- @method('PATCH') --}}
                      <div class="card card-default card-primary">
                        <div class="card-header">
                          <h3 class="card-title">Edit {{ $blog_info->blog_name }} URL</h3>
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="blog_url" name="blog_url" placeholder="Enter URL" value="{{ $blog_info->blog_url }}">
                                  </div>
                            </div>
