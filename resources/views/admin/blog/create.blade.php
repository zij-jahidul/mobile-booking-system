          ...
          <div class="row">
            <div class="col-12">
                ...
                <section class="content">
                    <div class="container-fluid">
                      <!-- SELECT2 EXAMPLE -->
                    <form action="{{ url('admin/add-blog-post') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PATCH') --}}
                          ...
                          <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="blog_title" name="blog_title" placeholder="Enter Name" value="{{ old('blog_title') }}">
                                  </div>
                            </div>
                            <!-- /.col -->
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    <label for="blog_long_description">Blog long Description</label>
                                    <textarea name="blog_long_description" id="blog_long_description" class="form-control" rows="3">{{ old('blog_long_description') }}</textarea>
                                  </div>
                            </div>
                            <!-- /.col -->
                          </div>
...
<script>
    ClassicEditor
            .create( document.querySelector( '#blog_short_description' ) )
            .then( editor => {
                    console.log( editor );
            } )
            .catch( error => {
