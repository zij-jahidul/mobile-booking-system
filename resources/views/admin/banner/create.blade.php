          ...
          <div class="row">
            <div class="col-12">
                ...
                <section class="content">
                    <div class="container-fluid">
                      <!-- SELECT2 EXAMPLE -->
                    <form action="{{ url('admin/add-banner-post') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PATCH') --}}
                          ...
                          <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="banner_title" name="banner_title" placeholder="Enter Name" value="{{ old('banner_title') }}">
                                  </div>
                            </div>
                            <!-- /.col -->
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="banner_url" name="banner_url" placeholder="Enter URL" value="{{ old('banner_url') }}">
                                  </div>
                            </div>
                            <!-- /.col -->
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    <label for="banner_long_description">Banner long Description</label>
                                    <textarea name="banner_long_description" id="banner_long_description" class="form-control" rows="3">{{ old('banner_long_description') }}</textarea>
                                  </div>
                            </div>
                            <!-- /.col -->
                          </div>
...
<script>
    ClassicEditor
            .create( document.querySelector( '#banner_short_description' ) )
            .then( editor => {
                    console.log( editor );
            } )
            .catch( error => {
