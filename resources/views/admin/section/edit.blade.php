            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                @endif
                    {{-- error end --}}
                <!-- form start -->
                <form action="{{ url('admin/edit-section-post') }}" method="POST">
                    @csrf
                    <input type="hidden" name="section_id" value="{{ $section_info->id }}">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Section Name</label>
                      <input type="text" class="form-control" value="{{ $section_info->name }}" placeholder="Enter Section name" name="name" required>
                    </div>
                  </div>
                  <!-- /.card-body -->
